...
namespace SetOperators
{
    class Program
    {
        ...
        class LinqSamples
        {
            ...
            [Description("This sample uses Distinct to remove duplicate elements in the sequence of" +
                "factors of 300")]
            public void Linq46()
            {
            ...
            [Category("Set Operators")]
            [Description("This sample uses the Union method to create one sequense that contains the unique first letter " +
            ...
            [Category("Set Operators")]
            [Description("This sample uses Except to create a sequence that contains the calies from numbersA" +
            ...
            [Category("Set Operators")]
            [Description("Thi sample uses Except to create one sequence that contains the first letters " +
                "of product names that are not also first letter of customer names.")]
            public void Linq53()
            {
                List<Product> products = GetProductList();
                List<Customer> customers = GetCustomerList();

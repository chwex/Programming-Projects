...
namespace ProjectionOperators
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //les.DataSetLinq17();    // This sample uses a compound from clause to select all orders where order total is greater than 2000.00...
        ...
        private class LinqSamples
        {
            ...
            [Description("This sample uses select to produce a sequence of the uppercase" +
                "and lowercase versions of each word i the original array.")]
            ...
            [Category("Projection Operators")]
            [Description("This sample combines selecct and where to make a simpe query that returns " +
            ...
            [Category("Projection Operators")]
            [Description("This sample uses a compound from clause to select all orders where the " +
                "order total is greater than 2000.00 and uses from assigment to avoid " +
            ...
            [Category("Projection Operators")]
            [Description("This sample uses multiple from clauses so that filtering in customers can " +
                "be done before selecting their orders.  THis makes the query more efficient by " +
                "not selecting and then discarging orders for customers outside of Washington.")]
            ...
            [Description("This sample uses an indexed SelectMany clause to select all orders, " +
                "while referring to cusstomers by the order in which they are returned " +
                "from the query.")]
            public void DataSetLinq19()
            {
                ...
                {
                    Console.WriteLine("Customer Index: " + c.CustomerIndex + " has an order with OrderID " + c.OrderID);
                }
            }

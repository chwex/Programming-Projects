...
namespace ConversionOperators
{
    class Program
    {
        ...
        class LinqSamples
        {
            ...
            [Description("This sample uses ToArray to inmediatelly evaluate a sequence into an array")]
            public void Linq54()
            {
            ...
            [Category("Conversion Operators")]
            [Description("This sample uses ToList to immediately evalueate a sequence into a List<T>")]
            public void Linq55()
            {
            ...
            [Category("Conversion Operators")]
            [Description("This sample uses ToDictionary ti immediately evaluate a sequence and a " +
                "related key expression into a dictionary.")]
            public void Linq56()
            {

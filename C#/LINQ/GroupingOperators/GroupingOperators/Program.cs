...
namespace GroupingOperators
{
    class Program
    {
        ...
        private class LinqSamples
        {
            ...
            [Description("This sample uses group by to partition list of numbers by " +
                "their remander when divided by 5")]
            ...
            [Category("Grouping Operators")]
            [Description("This sample uses group to partition a list of products by category.")]

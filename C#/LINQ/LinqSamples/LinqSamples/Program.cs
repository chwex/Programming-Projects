...
namespace LinqExamples
{
    class Program
    {
        ...
        public class LinqSamples
        {
            ...
            [Description("This sample uses the where clause to find all elements"
            ...
            [Description("This sample uses the where clause to find all products that are" +
                " of stock")]
            ...
            [Description("THis sample uses the where clause to find all products that are in" +
                "stock and cost more than 3.00 per unit.")]
            public void Linq3()
            {
                List<Product> products = GetProductList();
            ...
            [Description("This sample uses the where clause to find all customers" +
                "in Washington and then it uses a foreach loop to iterate over all the" +
                "orders collection that belongs to each customer")]
            ...
            [Description("This sample demonstrates an indexed where clause that returns" +

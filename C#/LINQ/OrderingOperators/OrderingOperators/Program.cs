...
namespace OrderingOperators
{
    class Program
    {
        ...
        class LinqSamples
        {
            ...
            [Description("This sample uses orderby to sort a list of words alpgobetically.")]
            public void Linq28()
            {
            ...
            //Custom pomparer for use with ordering operators
            ...
            [Description("THis sample uses an orderBy clause with a custom comparer to " +
                "do a case- insensitive sort of words in an array")]
            public void Linq31()
            {
            ...
            public void Linq32()
            {
                ...
                Console.WriteLine("THe doules from hightest to lowest:");
            ...
            public void Linq33()
            {
                ...
                var sortedProducts =
                    ...
                    select prod.UnitsInStock +" "+ prod.ProductName;
            ...
            [Category("Ordering Operators")]
            [Description("THe first qury un this sample uses method intax to call orderBy and ThenBy with a custom comparer to " +
                "sort first by word length and then by a case-insentitive sort of the words in tan array. " +
            ...
            public void Linq36()
            {
                ...
                //Another way, TODO is this use of ThenBy correct? it seems to work in this sample array.
                var sortedWords2 =
                    from word in words
                    orderby word.Length
                    select word;
            ...
            [Description("This sample uses a compound orderby to sort a list of products, " +
                "forst by category, and then by unit price, from highest to lowest.")]
            public void Linq37()
            {
                List<Product> products = GetProductList();
            ...
            [Description("This sample uses an OrderBy and a ThenBy clause with a custom comparer to " +
                "sort first by word length and then by a case- insentitive descending sort " +
                "of the words in the array")]
            public void Linq38()
            {
                string[] words = { "aPPLE", "AbAcUs", "bRaNcH", "BlUeBeRrY", "ClOvEr", "cHeRry" };
            ...
            [Category("Ordering Operators")]
            [Description("This sample uses Reverse to create a list of all digits un the array whose " +

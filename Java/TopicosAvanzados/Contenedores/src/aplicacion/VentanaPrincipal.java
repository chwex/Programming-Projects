...
public class VentanaPrincipal extends JFrame implements ActionListener 
{
	...
	public VentanaPrincipal(){
		...
		informacionTopicos="Topicos avanzados de programación es una materia\n";
		informacionTopicos+="de Ingenieria en Sistemas Computacionales, que trata\n";
		informacionTopicos+="temas como Eventos, GUI, Genericos, Hilos, etc.\n\n";
		informacionTopicos+="itculiacan.webs.com\n\n\n";
		
		/**/
		/*permite iniciar las propiedades de los componentes*/
		iniciarComponentes();
   		/*Asigna un titulo a la barra de titulo*/
		setTitle("Topicos : JFrame VentanaPrincipal");
	...
	public void actionPerformed(ActionEvent evento) {
		...
		if (evento.getSource()==menuItemBlog) {
			JOptionPane.showMessageDialog(null, informacionTopicos,"Topicos!!!",JOptionPane.WARNING_MESSAGE);
		}
	}
}
